...
import { optionalStringField } from '@/lib/validations';
...
const formSchema = z.object({
  to: z
    .array(z.string().email('Invalid email format').refine((val) => !hasEmoji(val), { message: 'Email cannot contain emojis' }))
    .nonempty('To field is required'),
  subject: z.string().nonempty('Subject is required').refine((val) => !hasEmoji(val), { message: 'Subject cannot contain emojis' }),
  message: z.string().nonempty('Message is required').refine((val) => !hasEmoji(val), { message: 'Message cannot contain emojis' })
});
