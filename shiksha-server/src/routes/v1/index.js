...
import {
  ...
  deleteInstituteInquiry,
  getInstituteInquiries,
  getInstituteInquiry,
  updateInstituteInquiry,
} from "../../controllers/institute-inquiry-controller.js";
import {
  createCounselor,
  deleteCounselor,
  getCounselor,
...
} from "../../controllers/question-answer-controller.js";
import {
  createWishlist,
  deleteWishlist,
  getWishlist,
...
router.get(
  "/users",
  UserMiddleware.validateGetAllRequest,
  accessTokenAutoRefresh,
  passport.authenticate("jwt", { session: false }),
  getUsers
);
